                        ...
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <a type="button" href="/admin/objectCheck/add/{{$subject->id}}" class="btn btn-sm btn-outline-secondary">принять №{{$subject->id}}</a>
                                        <a type="button" href="/admin/objectCheck/delete/{{$subject->id}}" class="btn btn-sm btn-outline-secondary">удалить №{{$subject->id}}</a>
                                    </div>
